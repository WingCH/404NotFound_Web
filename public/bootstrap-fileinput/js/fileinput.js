...
(function(factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function(options, refreshMode) {
            ...
            self.isClickable = self.browseOnZoneClick && self.showPreview && (self.isAjaxUpload && self.dropZoneEnabled || !$h.isEmpty(self.defaultPreviewContent));
        ...
        _initTemplateDefaults: function() {
            ...
            tActionDownload = '<button type="button" class="kv-file-download {downloadClass}" title="{downloadTitle}" ' + 'data-url="{downloadUrl}" data-caption="{caption}">{downloadIcon}</button>';
            ...
            tOffice = '<iframe class="kv-preview-data file-preview-office" ' + 'src="https://docs.google.com/gview?url={data}&embedded=true" {style}></iframe>';
            ...
            self.defaults = {
                ...
                fileTypeSettings: {
                    ...
                    office: function(vType, vName) {
                        return $h.compare(vType, /(word|excel|powerpoint|office|iwork-pages|tiff?)$/i) || $h.compare(vName, /\.(rtf|docx?|xlsx?|pptx?|pps|potx?|ods|odt|pages|ai|dxf|ttf|tiff?|wmf|e?ps)$/i);
                    },
        ...
        _initPreviewCache: function() {
            ...
            self.previewCache = {
                ...
                count: function() {
                    return !!self.previewCache.data && !!self.previewCache.data.content ? self.previewCache.data.content.length : 0;
                },
                get: function(i, isDisabled) {
                    ...
                    if (asData) {
                        ...
                        out = parseTemplate('generic', content, fname, ftype, previewId, ftr, ind, frameClass, cat).setTokens({
                            'content': data.content[i]
                        });
                    }
        ...
        _setZoomContent: function($frame, animate) {
            var self = this,
                $content, tmplt, body, title, $body, $dataEl, config, pid = $frame.attr('id'),
                $modal = self.$modal,
        ...
        _generatePreviewTemplate: function(cat, data, fname, ftype, previewId, isError, size, frameClass, foot, ind, templ) {
            var self = this,
                ...
                config = screenW < 400 ? (self.previewSettingsSmall[cat] || self.defaults.previewSettingsSmall[cat]) : (self.previewSettings[cat] || self.defaults.previewSettings[cat]),
            ...
            if (chkTypes || chkMimes) {
                ...
                if ($img.length && self.autoOrientImage) {
                    $h.validateOrientation(file, function(value) {
                        ...
                        var $zoomImg = $preview.find('#zoom-' + previewId + ' img'),
                            css = 'rotate-' + value;
                        if (value > 4) {
        ...
        _updateFileDetails: function(numFiles) {
            var self = this,
                ...
                name = ($h.isIE(9) && $h.findFileName($el.val())) || ($el[0].files[0] && $el[0].files[0].name) || (fileStack.length && fileStack[0].name) || '',
        ...
        _validateMinCount: function() {
            var self = this,
                len = self.isAjaxUpload ? self.getFileStack().length : self.$element.get(0).files.length;
        ...
        _getResizedImage: function(config, counter, numImgs) {
            ...
            if (!self.filestack[ind] || !isValidImage || (width <= maxWidth && height <= maxHeight)) {
                ...
                if (!isValidImage) {
                    throwError(self.msgImageResizeError, {
                        id: pid,
                        'index': ind
        ...
        _renderThumbProgress: function() {
            var self = this;
            return '<div class="file-thumb-progress kv-hidden">' + self.progressTemplate.setTokens({
                'percent': '0',
        ...
        _change: function(e) {
            ...
            self.fileInputCleared = false;
            var tfiles = [],
                msg, total, isDragDrop = arguments.length > 1,
        ...
        //     self.fileids = newids;
        // },
        //https://github.com/kartik-v/bootstrap-fileinput/issues/938
        _resetFileStack: function() {
            var self = this,
                i = 0,
                newstack = [],
